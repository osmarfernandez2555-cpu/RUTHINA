const BudgetPDF = {
  ...
  collect() {
    ...
    return {
      ...
      permuPos: gn('b-perm-pos') || 0,
      permuPer: gn('b-perm-per') || 0,
      ...
      gastos: gn('b-gastos') || 4.2,
      cuotaManual: gn('b-cuota-manual') || 0,

      // BNA / Crédito personal 1
      tieneBNA: gc('toggle-bna'),
      bnaBanco: g('b-bna-banco'),
      bnaMonto: gn('b-bna-monto'),
      bnaTNA: gn('b-bna-tna') || 38,
      bnaCuotas: parseInt(g('b-bna-cuotas')) || 24,
      bnaGastoFijo: gn('b-bna-gasto-fijo') || 0,
      bnaGastoPorc: gn('b-bna-gasto-porc') || 0,
      bnaCuotaManual: gn('b-bna-cuota-manual') || 0,

      // Crédito personal 2
      tieneBNA2: gc('toggle-bna2'),
      bna2Banco: g('b-bna2-banco'),
      bna2Monto: gn('b-bna2-monto'),
      bna2TNA: gn('b-bna2-tna') || 38,
      bna2Cuotas: parseInt(g('b-bna2-cuotas')) || 24,
      bna2GastoFijo: gn('b-bna2-gasto-fijo') || 0,
      bna2GastoPorc: gn('b-bna2-gasto-porc') || 0,
      bna2CuotaManual: gn('b-bna2-cuota-manual') || 0,

      // PSA
      tienePSA: gc('toggle-psa'),
      psaTipo: document.querySelector('input[name="psa-tipo"]:checked')?.value || '0km',
      psaMonto0: gn('b-psa-monto-0'),
      psaCuotas0: parseInt(g('b-psa-cuotas-0')) || 24,
      psaGasto0: gn('b-psa-gasto-0') || 14.54,
      psaCuotaManual0: gn('b-psa-cuota-manual-0') || 0,
      psaMontoP: gn('b-psa-monto-p'),
      psaCuotasP: parseInt(g('b-psa-cuotas-p')) || 24,
      psaTNAP: gn('b-psa-tna-p') || 47.9,
      psaQ: gn('b-psa-q') || 10,
      psaIVA: gn('b-psa-iva') || 4,
      psaGest: gn('b-psa-gest') || 5,
      psaCuotaManualP: gn('b-psa-cuota-manual-p') || 0,

      // Adelanto
      adelanto: gn('b-adelanto'),

      // Meta
      vigencia: g('b-vigencia') || '72 horas',
